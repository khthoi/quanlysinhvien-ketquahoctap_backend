...
@Module({
  imports: [TypeOrmModule.forFeature([KetQuaHocTap, SinhVienLopHocPhan, LopHocPhan, NguoiDung, KhenThuongKyLuat, KetQuaHocTap, LopHocPhan, SinhVien, NguoiDung, KhenThuongKyLuat])],
